...
var patterns = [
  {
    ...
    "begin": "((@)(interface|protocol))(?!.+;)\\s+([A-Za-z][A-Za-z0-9]*)\\s*((:)(?:\\s*)([A-Za-z][A-Za-z0-9]*))?(\\s|\\n)?",
    "captures": {
      "6": {
  ...
  },
  {
    ...
    "begin": "((@)(implementation))\\s+([A-Za-z][A-Za-z0-9]*)\\s*(?::\\s*([A-Za-z][A-Za-z0-9]*))?",
    "captures": {
      "1": {
        "name": "storage.type.objc"
      },
...
exports.Objective-CSyntax = new TextmateSyntax(repositories, patterns);
