"define metadata";
({
    "description": "Ruby Experimental syntax highlighter",
    ...
    "provides": [
        {
            ...
            "pointer": "#Ruby ExperimentalSyntax",
            "fileexts": null
        }
    ]
});
...
exports.Ruby ExperimentalSyntax = new TextmateSyntax(repositories, patterns);
