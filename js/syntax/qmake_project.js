"define metadata";
({
    "description": "qmake Project file syntax highlighter",
    ...
    "provides": [
        {
            "ep": "syntax",
            "name": "pro",
            "pointer": "#qmake Project fileSyntax",
            "fileexts": [
  "pro",
  "pri"
]
...
exports.qmake Project fileSyntax = new TextmateSyntax(repositories, patterns);
